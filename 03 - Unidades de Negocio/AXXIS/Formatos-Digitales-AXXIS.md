...
ai-first: true
tags: [axxis, formatos-digitales, contenido, ns03]
---
...
### "Proyectos que hablan" — Podcast
- **Estado:** Nuevo
- **Tipo:** Audio + Video
- **Distribución:** YouTube · Spotify · Cápsulas 60 seg. (IG, TikTok)
...
### Connect And Collab — Conversatorio
- **Estado:** Nuevo
- **Tipo:** Presencial + Streaming
- **Distribución:** YouTube (streaming en vivo + grabación) · IG (clips)
