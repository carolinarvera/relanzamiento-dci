...
date: 2026-06-24
type: dashboard-tab
tags: [diners, dashboard, next-steps, roadmap, junio-2026]
related-projects: [diners, revenue-growth, club-beneficios]
related-people: [carolina-ramirez, paola-gordillo, simon-granja, natalia-castano]
ai-first: true
confidence: high
---
...
## FOCO: 4 frentes activos — organizados por tipo de accion

---

### Revenue y Pauta Propia

| # | Accion | Owner | Deadline |
|---|--------|-------|---------|
| 1 | Auditar tarifario pauta propia digital Diners vs benchmark premium CO | Carolina | 4 jul |
| 2 | Revisar portafolio de formatos de pauta — identificar los de mayor CPM y los infravendidos | Carolina | 4 jul |
| 3 | Construir pipeline de prospectos para pauta propia (sectores: lujo, gastronomia, viajes, moda) | Natalia Castano | 11 jul |
| 4 | Definir meta mensual de pauta propia Jul-Dic y tracking semanal | Carolina | 30 jun |
| 5 | Documentar separacion pauta propia vs campanas clientes (Rolex etc.) en Looker | Carolina | 30 jun |

> Nota: campanas de clientes tipo Rolex = INGRESOS, nunca incluir en auditoria pauta propia.
...
### Audiencia y Contenido Digital

| # | Accion | Owner | Deadline |
|---|--------|-------|---------|
| 11 | Definir baseline de metricas: visitas web, engagement, open rate newsletter | Simon Granja + Jeison | 4 jul |
| 12 | Auditar SEO tecnico Diners — errores criticos, indexacion, schema | Simon Granja | 11 jul |
| 13 | Activar estrategia de formatos IA en contenido (ver [[Diners_02_Formatos_IA_2026-06]]) | Simon Granja | Jul 2026 |
| 14 | Establecer cadencia editorial de redes con Paola — frecuencia, formatos, pilares | Paola Gordillo | 4 jul |
| 15 | Revisar y optimizar newsletter — segmentacion, cadencia, CTA | Paola Gordillo | 11 jul |

---

### Precios, Suscripciones y Pricing

| # | Accion | Owner | Deadline |
|---|--------|-------|---------|
| 16 | Benchmarkear precios suscripcion digital Diners vs revistas premium regionales | Carolina | 11 jul |
| 17 | Propuesta de pricing para suscripciones digitales y Club — llevar a Catalina para aprobacion | Carolina | 18 jul |
| 18 | Definir CTA de suscripcion en articulos — inline y post-lectura | Simon Granja | 18 jul |
| 19 | Crear landing de suscripcion Diners con propuesta de valor clara | Simon Granja | 25 jul |

---

## Roadmap Jul-Sep 2026
...
## Log de decisiones clave (junio 2026)
