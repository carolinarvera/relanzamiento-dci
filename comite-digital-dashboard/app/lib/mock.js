...
function mockBrand(brand, range) {
  ...
  return {
    ...
    audience: {
      ...
      channels: [['Organic Search', 0.37, 0.35], ['Paid Social', 0.29, 0.26], ['Paid Search', 0.05, 0.04], ['Direct', 0.15, 0.18], ['Referral', 0.08, 0.09], ['Organic Social', 0.06, 0.08]].map(([name, pct, prevPct]) => ({ name, pct, prevPct, prevSessions: Math.round(sessions * prevPct * 0.9), prevViews: Math.round(total * prevPct * 0.9), sessions: Math.round(sessions * pct), users: Math.round(users * pct), views: Math.round(total * pct) })),
      ai: { pages: [], sources: [] },
      interests: [['Viajes y turismo', 0.31], ['Arquitectura y diseño', 0.27], ['Gastronomía y vinos', 0.24], ['Moda y lujo', 0.19], ['Decoración del hogar', 0.17], ['Automóviles', 0.12]].map(([name, pct]) => ({ name, pct })),
      ...
      interestsBySegment: {
        ...
        rows: [
          ['Viajes y turismo', [0.34, 0.27, 0.22, 0.33, 0.35, 0.33, 0.26]],
          ['Arquitectura y diseño', [0.24, 0.31, 0.18, 0.26, 0.32, 0.29, 0.22]],
          ['Gastronomía y vinos', [0.25, 0.23, 0.15, 0.22, 0.28, 0.30, 0.27]],
          ['Moda y lujo', [0.27, 0.10, 0.24, 0.24, 0.19, 0.14, 0.09]],
          ['Decoración del hogar', [0.24, 0.09, 0.10, 0.16, 0.21, 0.22, 0.17]],
          ['Automóviles', [0.06, 0.19, 0.11, 0.13, 0.14, 0.12, 0.10]],
