...
- **AXXIS convierte 7× mejor que Diners en la misma ventana — investigar por qué antes de rediseñar el flujo de Diners desde cero.** GA4 1-25 ago: AXXIS registra 22 "Finalizar compra suscripción" contra 3 de Diners, con menos leads de entrada (30 vs. 43 `submit_lead_form`). Conseguir el mismo reporte de embudo de 4 pasos para AXXIS — si no tiene la misma pared de login obligatorio que Diners, ahí está la corrección lista para replicar en vez de diseñar una nueva.
