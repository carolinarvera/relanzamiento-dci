...
- **Confirmado con GA4 de Diners: el embudo roto es de la compañía, no solo de AXXIS.** 1-25 ago: 104,761 sesiones, solo 3 eventos clave registrados (0.003%) — y los tres desde Organic Search, cero desde Paid Social o Paid Search pese a ser >40% del tráfico. Pero hay ~$41,472 en ingresos registrados en el mismo periodo con casi ningún evento clave — señal de que el "evento clave" configurado en GA4 puede no estar mapeado al evento real de compra. Auditar la configuración de eventos clave/ecommerce en GA4 de Diners antes de reportar la cifra de conversión — podría estar subestimada por un problema de tracking, no de negocio.
