...
| Canal | Evidencia |
|---|---|
| Meta Ads | Campañas "ventas: suscripción" (AXXIS + Diners) — con gasto acumulado y **0 conversiones trackeadas** |
| Social orgánico | 1 de 30 posts/reels analizados (AXXIS+Diners) menciona suscripción |
| Google Ads | Campaña Performance Max **"Suscriptores"** — **detenida**, "se rechazó la mayoría de los grupos de recursos" |
...
**Consecuencia directa:** ninguna acción de pauta, contenido o SEO de este plan tiene sentido escalarla hasta resolver Fase 0. Es la misma conclusión a la que llegamos con la pasarela de checkout ya reportada (9 personas atascadas, cero ingresos) — este documento la confirma desde 4 ángulos adicionales.
...
| 2 | Investigar por qué se rechazaron los asset groups de la PMax "Suscriptores" en Google Ads y volver a lanzarla con recursos conformes | Growth / agencia Google Ads | Presupuesto diario ya aprobado y sin usar hace semanas |
...
**Hallazgo estructural:** el 60% del gasto activo de Diners en la semana medida paga por keywords donde Diners **ya rankea orgánico en posición 2-4** (termales cerca a Bogotá, restaurantes candelaria, karts). Es presupuesto pagando por tráfico gratis.
...
| Reactivar presencia de AXXIS en Google Ads (hoy sin inversión, todo detenido) | AXXIS cae -37% en orgánico; pauta debería ser la red de seguridad mientras se investiga la caída |
...
| Reservar el presupuesto liberado para relanzar "Suscriptores" PMax una vez resuelta Fase 0 | El único campaign con intención de compra directa no está corriendo |
