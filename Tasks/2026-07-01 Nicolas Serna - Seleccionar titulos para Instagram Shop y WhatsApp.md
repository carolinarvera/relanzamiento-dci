...
- Titulo exacto
- Precio actual
- Razon de inclusion (mayor venta / mayor busqueda / mejor para regalo corporativo)
- Disponibilidad de inventario confirmada

## Criterios de seleccion sugeridos
1. **Mayor rotacion historica** (los que Nicolas ya vendio / tiene demanda comprobada)
2. **Mejor fit regalo corporativo** (Arte + Arquitectura premium)
3. **Mejor SEO potencial** (titulos con nombre propio buscable — Abel Rodriguez, Pedro Nel Gomez, Andres Carne de Res)
...
## Deadline
Antes de la reunion del jueves Jul 3, 9am.
